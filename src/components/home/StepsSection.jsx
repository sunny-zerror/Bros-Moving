  ...
  return (
    <>
      <div className="w-full  h-fit relative">
        <img className='w-full' src="/images/homepage/steps_section/steps_bg.png" alt="" />

        <div className="w-full h-full flex flex-col justify-center absolute top-0 left-0 z-10 ">
          ...
          <div className=" w-full flex items-center justify-center gap-x-5 mt-20">
            <div className="w-[20vw] text-white relative overflow-hidden aspect-3/4 bg-[#F9F6F3] rounded-2xl flex flex-col justify-between p-7">
            ...
            <div className="w-[20vw]  relative overflow-hidden aspect-3/4 bg-[#F9F6F3] rounded-2xl flex flex-col justify-between p-7">
              <div className="w-full absolute inset-0 z-[1] h-full">
            ...
            <div className="w-[20vw]  relative overflow-hidden aspect-3/4 bg-[#F9F6F3] rounded-2xl  p-7">
              <div className="w-full absolute inset-0 z-[1] h-full">
