    ...
    <>
      <div className="w-full  padding pt-12! z-100  fixed  top-0 left-0">
        <div className="w-full flex items-center pb-4  justify-between border-b border-white/20 ">
          ...
          <nav className=" w-1/2 text-white justify-center flex items-center gap-x-5">
            {navLinks.map((link, i) => (
              <div key={i} className="">
          ...
          <div className=" w-[25%]  flex items-center justify-end gap-x-5 leading-none">
            ...
            <button className='flex items-center gap-x-2  bg-white rounded-full px-4 py-3'>  Get a Quote <img src="/icons/arrow-right.svg" className='w-5' alt="" /> </button>
          </div>
        </div>
      </div>
    </>
